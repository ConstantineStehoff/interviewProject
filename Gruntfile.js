module.exports = function (grunt) {
    ...
    grunt.initConfig({
        ...
        copy: {
          ...
          smartTable: {
            cwd: 'bower_components/angular-smart-table/dist',
            src: 'smart-table.min.js',           
            dest: 'dist/release/scripts',    
            expand: true
          },
          index: {
    ...
    // Default tasks.
    grunt.registerTask('default', ['clean', 'copy:files', 'concat', 'uglify', 
      'less', 'cssmin', 'copy:jquery', 'copy:angular', 'copy:smartTable', 'copy:index']);
